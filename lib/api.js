...
async function uploadFile(req, res) {
  ...
  try {
    ...
    console.log(`[Upload] copied to container: ${containerPath}`);

    // Set on the page's file input
    await bc.setFileInputFiles(pid, [containerPath]);
    console.log('[Upload] setFileInputFiles done');
    res.json({ ok: true });
  } catch (err) {
