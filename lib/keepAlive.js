 ...
 */
async function keepAliveRunningProfile({ containerManager, baseUrl, profile, fetchImpl = globalThis.fetch, onSuccess } = {}) {
  ...
  if (typeof onSuccess === 'function') await onSuccess(profileId);
  return { ran: true };
}
