...
/** No CDP activity for this long → close the collection page. 0 disables. */
function collectionPageIdleMs() {
  const parsed = parseInt(process.env.COLLECTION_PAGE_IDLE_MS, 10);
  if (process.env.COLLECTION_PAGE_IDLE_MS === '0') return 0;
...
module.exports = { maxRunningBrowsers, idleStopMs, collectionPageIdleMs, pickEvictionVictim };
